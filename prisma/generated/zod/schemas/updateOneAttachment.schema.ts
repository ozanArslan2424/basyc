...
export const AttachmentUpdateOneSchema: z.ZodType<Prisma.AttachmentUpdateArgs> = z
	.object({
		data: z.union([AttachmentUpdateInputObjectSchema, AttachmentUncheckedUpdateInputObjectSchema]),
		where: AttachmentWhereUniqueInputObjectSchema,
	})
	.strict() as unknown as z.ZodType<Prisma.AttachmentUpdateArgs>;

export const AttachmentUpdateOneZodSchema = z
	.object({
		data: z.union([AttachmentUpdateInputObjectSchema, AttachmentUncheckedUpdateInputObjectSchema]),
		where: AttachmentWhereUniqueInputObjectSchema,
	})
