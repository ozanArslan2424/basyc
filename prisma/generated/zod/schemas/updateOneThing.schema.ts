...
export const ThingUpdateOneSchema: z.ZodType<Prisma.ThingUpdateArgs> = z
	.object({
		data: z.union([ThingUpdateInputObjectSchema, ThingUncheckedUpdateInputObjectSchema]),
		where: ThingWhereUniqueInputObjectSchema,
	})
	.strict() as unknown as z.ZodType<Prisma.ThingUpdateArgs>;

export const ThingUpdateOneZodSchema = z
	.object({
		data: z.union([ThingUpdateInputObjectSchema, ThingUncheckedUpdateInputObjectSchema]),
		where: ThingWhereUniqueInputObjectSchema,
	})
