...
export const PersonUpdateOneSchema: z.ZodType<Prisma.PersonUpdateArgs> = z
	.object({
		data: z.union([PersonUpdateInputObjectSchema, PersonUncheckedUpdateInputObjectSchema]),
		where: PersonWhereUniqueInputObjectSchema,
	})
	.strict() as unknown as z.ZodType<Prisma.PersonUpdateArgs>;

export const PersonUpdateOneZodSchema = z
	.object({
		data: z.union([PersonUpdateInputObjectSchema, PersonUncheckedUpdateInputObjectSchema]),
		where: PersonWhereUniqueInputObjectSchema,
	})
