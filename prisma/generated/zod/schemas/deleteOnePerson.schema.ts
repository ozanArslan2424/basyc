...
export const PersonDeleteOneSchema: z.ZodType<Prisma.PersonDeleteArgs> = z.object({   where: PersonWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.PersonDeleteArgs>;
