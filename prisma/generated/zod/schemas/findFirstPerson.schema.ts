...
export const PersonFindFirstSelectSchema: z.ZodType<Prisma.PersonSelect> = z
	.object({
...
export const PersonFindFirstSelectZodSchema = z
	.object({
		id: z.boolean().optional(),
		createdAt: z.boolean().optional(),
		updatedAt: z.boolean().optional(),
...
export const PersonFindFirstSchema: z.ZodType<Prisma.PersonFindFirstArgs> = z
	.object({
		select: PersonFindFirstSelectSchema.optional(),
		orderBy: z
	...
	.strict() as unknown as z.ZodType<Prisma.PersonFindFirstArgs>;

export const PersonFindFirstZodSchema = z
	.object({
		select: PersonFindFirstSelectSchema.optional(),
		orderBy: z
			.union([PersonOrderByWithRelationInputObjectSchema, PersonOrderByWithRelationInputObjectSchema.array()])
